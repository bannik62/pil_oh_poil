<script>
  ...
  import AdvancedParameter from "../../module/services/serviceGestion/advanced/AdvancedParameter.svelte";
...
<!-- verification cookie de session pour les face du cube-->
{#if get(pageActuelle) === 'left' || get(pageActuelle) === 'bottom' || get(pageActuelle) === 'back'}
<CookieHautentifier />
{/if}
<header>
{#if currentPage === 'front'|| currentPage === 'right'|| currentPage === 'left'|| currentPage === 'top'|| currentPage === 'bottom' || currentPage === 'back' }
  <Navbar on:rotateCube={rotateCube} />
 
  {#if currentPage === 'back'}
  <Navbar on:rotateCube={rotateCube} class="navbar-back" />
  <style>
    .navbar-back {
      all: unset;
      display: none;
 ...
 {/if}
  ...
  <style>
    .btnNavAdminBoard {
      ...
      align-items: center;
      border-radius: 10px;
      animation: scaleAdminBoard 1s ease-out forwards;
    }

    @keyframes scaleAdminBoard {
      from {
        transform: scale(0);
        border-radius: 0;
      }
  ...
  <button role="button" class="btnNavSystem" on:click={() => handleClick('btnNav')} type="button" title="cordon" value="Navbar">
    Navbar
  </button>
  <style>
    .btnNavSystem {
      ...
      align-items: center;
      border-radius: 150%;
      animation: scaleUpSystem 1s ease-out forwards;
    }
  </style>
  {/if}
  ...
  <div class="cube" id="cube">
    <div class="cube-face cube-front">
      <div class="content-h1">
        <h1 id="h1Title">
          <img id="h1titlepng1" src={h1title} alt="icone spa" class="h1titlepng icone" />
          Pil Oh Poil
          <img id="h1titlepng2" src={h1title} alt="icone spa" class="h1titlepng icone" />
        </h1>
      </div>
    </div>
